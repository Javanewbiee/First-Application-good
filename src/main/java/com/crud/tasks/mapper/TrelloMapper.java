...
public class TrelloMapper {
    ...
    public List<TrelloBoardDto>mapToBeardDto(final List<TrelloBoard>trelloBoards) {
        return trelloBoards.stream()
                .map(trlloBoard -> new TrelloBoardDto(trlloBoard.getId(),trlloBoard.getName(),mapToListDto(trlloBoard.getLists())))
                .collect(toList());
    }
